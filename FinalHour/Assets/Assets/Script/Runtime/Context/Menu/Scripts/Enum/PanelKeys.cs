namespace Assets.Script.Runtime.Context.Menu.Scripts.Enum
{
    public static class PanelKeys
    {
        ...
        public const string OptionsPanelWeb = "OptionsPanelWeb";
        public const string InstructionsPanel = "InstructionsPanel";
        public const string SettingsPanel = "SettingsPanel";
        public const string SettingsPanelMobile = "SettingsPanelMobile";
        public const string CreditsPanel = "CreditsPanel";
        public const string ControlsPanel = "ControlsPanel";
    }
}
